...
var DEFAULT_KEY = 'QQdefault';

var RouteAggregator = function () {
  function RouteAggregator() {
    (0, _classCallCheck3.default)(this, RouteAggregator);
    ...
    this._routeIndices = new _weakMap2.default();
  ...
  RouteAggregator.prototype.updateRoute = function updateRoute(routerProps) {
    ...
    routes.forEach(function (route, i) {
      ...
      (0, _keys2.default)(componentMap).forEach(function (key) {
        ...
        !_reactRelay2.default.isContainer(component) ? process.env.NODE_ENV !== 'production' ? (0, _invariant2.default)(false, 'relay-nested-routes: Route with queries specifies component `%s` ' + 'that is not a Relay container.', component.displayName || component.name) : (0, _invariant2.default)(false) : void 0;

        var routeParams = (0, _getParamsForRoute2.default)({ route: route, routes: routes, params: params, location: location });
        (0, _assign2.default)(relayRoute.params, routeParams);
    ...
    relayRoute.name = ['XX_aggregated'].concat((0, _keys2.default)(relayRoute.queries)).join('__');
  ...
  RouteAggregator.prototype.getData = function getData(route) {
    ...
    for (var _iterator = (0, _keys2.default)(params), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : (0, _getIterator3.default)(_iterator);;) {
      ...
      if (!(0, _isEqual2.default)(this._data[paramName], params[paramName])) {
  ...
  RouteAggregator.prototype.getFragmentNames = function getFragmentNames() {
    return (0, _keys2.default)(this._fragmentSpecs);
  };
